...
<template>
    <GuestLayout>
        ...
        <div class="hidden bg-cover lg:block lg:w-1/2" style="background-image: url('img/remote-working.jpg');"></div>
            ...
            <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <a href="/google/redirect" class="flex items-center justify-center mt-4 text-gray-200 transition-colors bg-gray-800 duration-300 transform border rounded-lg   hover:bg-gray-600">
                    ...
                    <span class="w-5/6 px-4 py-3 font-bold text-center">Login via Google</span>
                </a>

                <div class="flex items-center justify-between mt-4">
                    <span class="w-1/5 border-b dark:border-gray-400 lg:w-1/4"></span>

                    <label class="text-xs text-center text-gray-500 uppercase">or login
                        with email</label>

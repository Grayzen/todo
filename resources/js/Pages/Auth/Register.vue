...
<template>
    <GuestLayout>
        ...
        <div class="flex w-full max-w-sm my-auto mx-auto overflow-hidden bg-gray-100 rounded-lg shadow-lg  lg:max-w-4xl">

                <div class="hidden bg-cover lg:block lg:w-1/2" style="background-image: url('https://images.unsplash.com/photo-1494621930069-4fd4b2e24a11?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=715&q=80');"></div>
                ...
                <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <Link :href="route('google.redirect')" class="flex items-center justify-center mt-4 text-gray-200 transition-colors bg-gray-800 duration-300 transform border rounded-lg   hover:bg-gray-600">
                        <div class="px-4 py-2">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <label class="text-xs text-center text-gray-500 uppercase">or register
                            with email</label>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mt-8">
                            <button class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-gray-800 rounded hover:bg-gray-600 focus:outline-none focus:bg-gray-600" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                                Register
                            </button>
                        </div>
                    </form>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <Link :href="route('login')" class="text-xs text-gray-500 uppercase hover:underline">Already registered?</Link>
